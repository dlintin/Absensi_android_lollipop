...
public class Server {
    ...
    public static final String PERORANG_REPORT = UTAMA + ANDROID_TABLE + "/showperorangreport.php?tglawal=";
    ...
    public static final String PERORANG = UTAMA + ANDROID_TABLE + "/perorang.php?name=";
}
